...
const effectsButton = setTooltip(setButtonLabel(createButton("演出: ON", () => {
    ...
    updateStatusMiniOverlays();
}), "演出: ON", "Effects: ON"), "奇跡演出・画面効果・エンディング演出をまとめてON/OFFします。デフォルトはONです。", "Toggle visual effects. Default is on.");
...
function showButtonHelpPopup(): void {
    showPopup("ボタン説明", `
        ...
        <p><b>演出:</b> 奇跡演出、画面効果、エンディング演出をまとめてON/OFFします。デフォルトはONです。</p>
