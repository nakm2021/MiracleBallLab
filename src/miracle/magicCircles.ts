...
export const MAGIC_CIRCLE_DEFS: MagicCircleDef[] = [
    {
        ...
        color: "#facc15",
        chant: "黄金照射",
        description: "盤面を発光させ、外から銀玉を呼び込みます。",
    },
    {
        kind: "moon",
        effect: "moon",
        ...
        color: "#bfdbfe",
        chant: "月重力",
        description: "重力を少し弱め、玉をふわっと流します。",
    },
    {
        kind: "star",
        effect: "star",
        ...
        color: "#fde68a",
        chant: "流星招来",
        description: "流れ星のように外側から玉が飛び込みます。",
    },
    {
        kind: "thunder",
        effect: "thunder",
    ...
    },
    {
        ...
        color: "#38bdf8",
        chant: "潮流反転",
        description: "津波のように盤面の流れを横へ押します。",
    },
    {
        kind: "earth",
        effect: "earth",
    ...
    },
    {
        ...
        color: "#e0f2fe",
        chant: "反射世界",
        description: "反射世界のように盤面を反転気味に揺らします。",
    },
    {
        kind: "dragon",
        effect: "dragon",
    ...
    },
    {
        ...
        color: "#86efac",
        chant: "極光流転",
        description: "オーロラの帯で盤面を照らし、銀玉を呼び込みます。",
    },
    {
        kind: "crystal",
        effect: "mirror",
    ...
    },
    {
        ...
        color: "#84cc16",
        chant: "蛇行龍脈",
        description: "龍脈の小型版として盤面をくねらせます。",
    },
    {
        kind: "prism",
        effect: "mirror",
        ...
        color: "#f0abfc",
        chant: "虹晶反射",
        description: "虹色の反射で魔法陣の結果を派手にします。",
    },
    {
        kind: "anchor",
        effect: "earth",
        ...
        color: "#94a3b8",
        chant: "重力固定",
        description: "盤面を重く揺らし、金具ピンをしならせます。",
    },
    {
        kind: "bell",
        effect: "thunder",
    ...
    },
    {
        ...
        color: "#f0abfc",
        chant: "蓮華開花",
        description: "花型の観測ピンをさらに華やかに広げます。",
    },
    {
        kind: "sword",
        effect: "wind",
    ...
    },
    {
        ...
        color: "#67e8f9",
        chant: "宝冠降臨",
        description: "宝石の光をまとった観測ピンを置きます。",
    },
    {
        kind: "spiral",
        effect: "wind",
    ...
    },
    {
        ...
        color: "#fb923c",
        chant: "火口解放",
        description: "下から噴き上がるような玉侵入を起こします。",
    },
    {
        kind: "snow",
        effect: "moon",
    ...
    },
    {
        ...
        color: "#cbd5e1",
        chant: "機関全開",
        description: "歯車のようにピンを激しく反応させます。",
    },
    {
        kind: "lantern",
        effect: "sun",
    ...
    },
    {
        ...
        color: "#f59e0b",
        chant: "衣、天へ舞う",
        description: "隠し魔法陣。穴子の天ぷらの衣が流星のように舞います。",
    },
];
...
export function classifyMagicCircle(points: Array<{ x: number; y: number; t: number }>): MagicCircleDef {
