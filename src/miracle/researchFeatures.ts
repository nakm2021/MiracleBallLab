...
export const EVENT_SEASONS: EventSeasonDef[] = [
    {
        ...
        missions: [
            ...
            },
            {
                id: "discover-5",
                label: "深海標本",
                description: "奇跡図鑑を5種類以上にする",
                metric: "discovered",
                target: 5,
                rewardPoint: 6,
                rewardTickets: { normal: 3 },
            },
            {
                id: "craft-1",
                label: "海底工房",
                description: "奇跡クラフトを1回行う",
                metric: "craft",
                target: 1,
                rewardPoint: 8,
                rewardTheme: "glacier",
    ...
    },
    {
        ...
        missions: [
            ...
            },
            {
                id: "discover-8",
                label: "閃光図鑑",
                description: "奇跡図鑑を8種類以上にする",
                metric: "discovered",
                target: 8,
                rewardPoint: 10,
                rewardTickets: { normal: 5 },
            },
        ],
    },
    {
        ...
        missions: [
            ...
            },
            {
                id: "craft-3",
                label: "神域錬成",
                description: "奇跡クラフトを3種類解放する",
                metric: "craft",
                target: 3,
                rewardPoint: 14,
                rewardTickets: { rare: 2 },
            },
            {
                id: "score-500k",
                label: "神域論文",
                description: "通算スコア500,000以上にする",
                metric: "score",
                target: 500000,
                rewardPoint: 18,
                rewardTheme: "wafuu",
                rewardTickets: { divine: 1 },
            },
        ],
    },
];
