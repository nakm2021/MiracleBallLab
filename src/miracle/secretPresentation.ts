...
export const SECRET_DEFS: SecretDef[] = [
    {
        id: "keyword-miracle",
        label: "MIRACLE コード",
        hint: "PCで研究所の合言葉を英字入力",
        detail: "キーボードで隠しコードを入力しました。今日の研究所は少しだけ騒がしくなります。",
        rewardScore: 7777,
    },
    {
        id: "keyword-lab",
    ...
    },
    {
        ...
        label: "SUN コード",
        hint: "太陽に関係する英字を入力",
        detail: "黒い太陽を探す研究者用の短縮コードです。",
        rewardScore: 5000,
    },
    {
        id: "favicon-five-taps",
        label: "favicon 5連打",
        hint: "起動画面のロゴを連打",
        detail: "起動ロゴを5回タップしました。ロード画面にも秘密がありました。",
        rewardScore: 7777,
    },
    {
        id: "pause-seven-taps",
        label: "時間停止ごっこ",
        hint: "一時停止を短時間に何度も操作",
        detail: "一時停止操作を短時間に7回行いました。時間を止めようとする研究記録です。",
        rewardScore: 9000,
    },
    {
        id: "settings-three-open",
        label: "設定室の常連",
        hint: "スマホの設定画面を何度か開く",
        detail: "スマホ設定画面を3回開きました。設定画面にも観測ログが残ります。",
        rewardScore: 6000,
    },
    {
        id: "familiar-neko",
        label: "使い魔契約: ねこ式使い魔",
        hint: "使い魔研究室かPCキー入力で猫系コード",
        detail: "ねこ式使い魔を解放しました。",
        rewardScore: 14000,
    },
    {
        id: "familiar-kuro",
        label: "使い魔契約: 黒羽コウモリ",
        hint: "使い魔研究室かPCキー入力で黒羽系コード",
        detail: "黒羽コウモリを解放しました。",
        rewardScore: 14000,
    },
    {
        id: "familiar-tokei",
        label: "使い魔契約: 時計キツネ",
        hint: "使い魔研究室かPCキー入力で時計系コード",
        detail: "時計キツネを解放しました。",
        rewardScore: 14000,
    },
    {
    ...
    },
    {
        id: "familiar-miko",
        label: "使い魔契約: 秘密巫女うさぎ",
        hint: "使い魔研究室かPCキー入力で短い秘密コード",
        detail: "秘密巫女うさぎを解放しました。",
        rewardScore: 14000,
    },
    {
        id: "skill-combo-lab",
        label: "三種の介入",
        hint: "実験中に衝撃波→磁石→時止めの順で使う",
        detail: "盤面介入スキルを決まった順番で使いました。研究員が完全に介入しています。",
        rewardScore: 12000,
    },
];
