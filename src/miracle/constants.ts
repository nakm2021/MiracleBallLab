...
const REMOTE_MIRACLE_ASSET_BASE_URL = "https://pub-53a4b50cc39c4d7882f67fc9340fe6e8.r2.dev";
const LOCAL_MIRACLE_ASSET_PROXY_BASE_URL = `${import.meta.env.BASE_URL}remote-miracle-assets`.replace(/\/$/, "");
export const MIRACLE_ASSET_BASE_URL = import.meta.env.DEV
    ? LOCAL_MIRACLE_ASSET_PROXY_BASE_URL
    : REMOTE_MIRACLE_ASSET_BASE_URL;
...
export const SECRET_KEY_MAX_LENGTH = Math.max(
    SECRET_KEY_SEQUENCE.length,
    ...Object.keys(SECRET_KEY_SEQUENCES).map((x) => x.length),
);
