...
export type BossExperimentRecord = {
    id: string;
    bossId: string;
    bossName: string;
    cleared: boolean;
...
export type SavedRecords = {
    ...
    gachaPoint?: number;
    gachaRewards?: GachaRewardEntry[];
    shopPurchased?: Record<string, number>;
    shopPurchases?: ShopPurchaseEntry[];
    seasonRewardClaimed?: Record<string, number>;
    seasonRewards?: SeasonRewardEntry[];
