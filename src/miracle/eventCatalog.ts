...
export const FUSION_DEFS: FusionDef[] = [
    {
        ...
        label: "王の流星群",
        rank: "UR",
        sourceKinds: ["crown", "shootingStar"],
        requiredCount: 1,
        description: "王と流れ星が同じ研究記録に残ると派生する、記念撮影向けの合成奇跡です。",
        rewardScore: 42000,
    },
    {
        id: "blue-angel",
        label: "蒼天の輪炎",
        rank: "SSR+",
        sourceKinds: ["blueFlame", "angelRing"],
        requiredCount: 1,
        description: "青い炎と天使輪が混ざった、静かに派手な派生奇跡です。",
        rewardScore: 28000,
    },
    {
        id: "heart-seven",
        label: "ラッキーハートセブン",
        rank: "SR+",
        sourceKinds: ["heart", "luckySeven"],
        requiredCount: 1,
        description: "桃色ハートとラッキーセブンの縁起を合わせた、やさしい確率改変です。",
        rewardScore: 18000,
    },
    {
        id: "black-rift",
        label: "黒裂日食",
        rank: "EX",
        sourceKinds: ["blackSun", "timeRift"],
        requiredCount: 1,
        description: "黒い太陽と時空の裂け目が揃ったときだけ研究所に記録される危険な派生です。",
        rewardScore: 120000,
    },
    {
        id: "lab-cosmos",
        label: "研究所宇宙卵",
        rank: "GOD",
        sourceKinds: ["labExplosion", "cosmicEgg"],
        requiredCount: 1,
        description: "研究所爆発と宇宙卵が同時期に観測された、ほぼ都市伝説の合成記録です。",
        rewardScore: 300000,
    },
];
...
export const NORMAL_BALL_TRAITS: NormalBallTraitDef[] = [
    ...
    },
    {
        ...
        label: "跳ね玉",
        mark: "跳",
        description: "よく跳ねるため、予想外の受け皿へ向かいやすい通常玉です。",
        rate: 0.052,
        radiusScale: 1.0,
        restitution: 1.04,
        density: 0.0009,
    ...
    },
    {
        ...
        label: "小粒玉",
        mark: "小",
        description: "少し小さく、ピンの間をすり抜けやすい通常玉です。",
        rate: 0.05,
        radiusScale: 0.74,
        restitution: 0.86,
        density: 0.00078,
    ...
    },
    {
        ...
        label: "のんびり玉",
        mark: "眠",
        description: "空気抵抗が大きく、ゆっくり落ちる通常玉です。",
        rate: 0.04,
        radiusScale: 1.0,
        restitution: 0.7,
        density: 0.001,
    ...
    },
    {
        ...
        label: "早足玉",
        mark: "速",
        description: "横方向に少し勢いを持って生まれる通常玉です。",
        rate: 0.035,
        radiusScale: 0.96,
        restitution: 0.9,
        density: 0.00105,
    ...
    },
    {
        ...
        label: "回転玉",
        mark: "回",
        description: "最初から強めに回転して、壁やピンで変な跳ね方をします。",
        rate: 0.032,
        radiusScale: 1.0,
        restitution: 0.88,
        density: 0.001,
    ...
    },
    {
        ...
        label: "うす玉",
        mark: "薄",
        description: "半透明で少し軽く、画面上で見つけにくい通常玉です。",
        rate: 0.026,
        radiusScale: 0.94,
        restitution: 0.96,
        density: 0.00082,
...
export const MIRACLE_CHAIN_DEFS: MiracleChainDef[] = [
    {
        id: "royal-starry-night",
        label: "王の星読み",
        rank: "CHAIN",
        sequence: ["crown", "shootingStar"],
        description: "王冠のあとに流れ星が続いた連鎖記録です。研究所が一瞬だけ星空になります。",
        rewardScore: 32000,
    },
    {
        id: "heart-lucky-shift",
        label: "幸運心拍",
        rank: "CHAIN",
        sequence: ["heart", "luckySeven"],
        description: "桃色ハートからラッキーセブンへつながった、やさしい確率連鎖です。",
        rewardScore: 38000,
    },
    {
        id: "blue-time-rift",
        label: "蒼炎時裂",
        rank: "CHAIN+",
        sequence: ["blueFlame", "timeRift"],
        description: "青い炎が時空の裂け目に飲まれた連鎖記録です。盤面が少し冷たく歪みます。",
        rewardScore: 62000,
    },
    {
        id: "black-lab-apocalypse",
        label: "黒日研究所崩壊",
        rank: "EX-CHAIN",
        sequence: ["blackSun", "labExplosion"],
        description: "黒い太陽の直後に研究所爆発が来た危険な連鎖です。",
        rewardScore: 160000,
    },
    {
        id: "last-cosmic-seal",
        label: "終末宇宙封印",
        rank: "GOD-CHAIN",
        sequence: ["blackSun", "timeRift", "cosmicEgg"],
        description: "黒い太陽、時空の裂け目、宇宙卵が順に並んだ最終級の連鎖です。",
        rewardScore: 420000,
    },
];
...
export const RARE_PIN_DEFS: RarePinDef[] = [
    ...
    },
    {
        kind: "rainbow",
        label: "虹ピン",
        description: "触れると奇跡予兆が出やすい特別なピンです。",
        fillStyle: "#a855f7",
        strokeStyle: "#fef3c7",
        rate: 0.005,
    },
...
const MASSIVE_MIRACLE_PREFIXES = [
    "月光",
    "星屑",
    "深海",
    "天界",
